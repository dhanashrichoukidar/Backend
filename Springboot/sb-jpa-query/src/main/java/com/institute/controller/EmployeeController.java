...
public class EmployeeController {
	...
	@DeleteMapping("/delete-emp-by-salary/{sl}")
	public CustomResponse deleteEmpBySal(@PathVariable("sl")double salary) {
		employeeRepository.deleteEmpBySalHql(salary);
		CustomResponse response = new CustomResponse(203, "Employee deleted by salary successfully...");
